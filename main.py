...
# slownik = {'siemandero':'ulepszone siema',"kys":'zyczenie dlugiego zycia', 'kc':'w tlumaczeniu kocham cie' }
# print(slownik['siemandero'])
# print(slownik['wtf'])
# print(slownik['lol'])

# Zad 3.

# slownik = {'eu4':'Europa universalis 4',"lol":'league of legends', 'h5':'heroes of might and magic 5' }
...
# system.stdout.write("liczby 3 poproszem  ")
